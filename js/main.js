...
document.addEventListener('DOMContentLoaded', () => {
    ...
    // ─── Custom Scroll for Booking Form ──────────────────────────
    function scrollToBookingForm() {
        const target = document.getElementById('booking-form');
        if (target) {
            const targetTop = target.getBoundingClientRect().top + window.scrollY;
            const headerHeight = parseInt(getComputedStyle(document.documentElement).getPropertyValue('--header-h'), 10) || 130;
            const offset = targetTop - headerHeight - 32; // 32px extra margin for better positioning
    ...
    const galleries = {
        videos: {
            ...
            items: [
                { type: 'video', src: 'assets/media/videos/optimized/IMG_0182.m4v' },
                { type: 'video', src: 'assets/media/videos/optimized/IMG_1102.m4v' },
                { type: 'video', src: 'assets/media/videos/optimized/IMG_1107.m4v' },
                { type: 'video', src: 'assets/media/videos/optimized/IMG_1446.m4v' },
                { type: 'video', src: 'assets/media/videos/optimized/IMG_2248.m4v' },
                { type: 'video', src: 'assets/media/videos/optimized/IMG_2760.m4v' },
                { type: 'video', src: 'assets/media/videos/optimized/IMG_3341.m4v' },
                { type: 'video', src: 'assets/media/videos/optimized/IMG_4861.m4v' },
                { type: 'video', src: 'assets/media/videos/optimized/IMG_5215.m4v' },
                { type: 'video', src: 'assets/media/videos/optimized/IMG_5229.m4v' },
                { type: 'video', src: 'assets/media/videos/optimized/IMG_6153.m4v' },
                { type: 'video', src: 'assets/media/videos/optimized/IMG_7133.m4v' },
                { type: 'video', src: 'assets/media/videos/optimized/IMG_8061.m4v' }
            ]
        },
        fotos: {
            title: "Portafolio Completo",
            items: [
                { type: 'img', src: 'assets/media/Fotos/optimized/IMG_4607.jpg' },
                { type: 'img', src: 'assets/media/Fotos/optimized/IMG_5214.jpg' },
                { type: 'img', src: 'assets/media/Fotos/optimized/IMG_6367.jpg' },
                { type: 'img', src: 'assets/media/Fotos/optimized/IMG_7090.jpg' },
                { type: 'img', src: 'assets/media/Fotos/optimized/IMG_7099.jpg' },
                { type: 'img', src: 'assets/media/Fotos/optimized/IMG_7716.jpg' },
                { type: 'img', src: 'assets/media/Fotos/optimized/IMG_7974.jpg' },
                { type: 'img', src: 'assets/media/Fotos/optimized/IMG_9020.jpg' },
                { type: 'img', src: 'assets/media/Fotos/optimized/IMG_9081.jpg' },
                { type: 'img', src: 'assets/media/Fotos/optimized/IMG_9233.jpg' },
                { type: 'img', src: 'assets/media/Fotos/optimized/IMG_9509.jpg' },
                { type: 'img', src: 'assets/media/Fotos/optimized/IMG_9759.jpg' }
            ]
        },
        disenos: {
            title: "Todos los Diseños",
            items: [
                { type: 'img', src: 'assets/media/diseños/optimized/IMG_1904.jpg', price: '$300.000', mpLink: 'https://mpago.la/1wXxiTC' },
                { type: 'img', src: 'assets/media/diseños/optimized/IMG_1922.jpg', price: '$160.000', mpLink: 'https://mpago.la/1h4MyrD' },
                { type: 'img', src: 'assets/media/diseños/optimized/IMG_1930.jpg', price: '$200.000', mpLink: 'https://mpago.la/1QTSZuF' },
                { type: 'img', src: 'assets/media/diseños/optimized/IMG_1931.jpg', price: '$250.000', mpLink: 'https://mpago.la/16Mw9cZ' },
                { type: 'img', src: 'assets/media/diseños/optimized/IMG_1932.jpg', price: '$300.000', mpLink: 'https://mpago.la/1yQcXxq' },
                { type: 'img', src: 'assets/media/diseños/optimized/IMG_1933.jpg', price: '$200.000', mpLink: 'https://mpago.la/2pzK5Cn' },
                { type: 'img', src: 'assets/media/diseños/optimized/IMG_1934.jpg', price: '$400.000', mpLink: 'https://mpago.la/1L7jEfC' },
                { type: 'img', src: 'assets/media/diseños/optimized/IMG_1936.jpg', price: '$600.000', mpLink: 'https://mpago.la/1CKNZeu' },
                { type: 'img', src: 'assets/media/diseños/optimized/IMG_1937.jpg', price: '$200.000', mpLink: 'https://mpago.la/1z733jn' },
                { type: 'img', src: 'assets/media/diseños/optimized/IMG_1940.jpg', price: '$400.000', mpLink: 'https://mpago.la/1WXtfxP' },
                { type: 'img', src: 'assets/media/diseños/optimized/IMG_1941.jpg', price: '$900.000', mpLink: 'https://mpago.la/32DzthE' },
                { type: 'img', src: 'assets/media/diseños/optimized/IMG_1942.jpg', price: '$70.000', mpLink: 'https://mpago.la/1To6gju' },
                { type: 'img', src: 'assets/media/diseños/optimized/IMG_1943.jpg', price: '$200.000', mpLink: 'https://mpago.la/2Nh1X56' }
            ]
        }
    };
            ...
            if (galleryId === 'disenos') {
                ...
                el.innerHTML = `
                    ...
                    <div class="design-card-body">
                        ...
                        <p class="design-desc">Diseño exclusivo listo para tatuar.</p>
    ...
    function openLightbox(src, type = 'img', price = null, mpLink = null) {
        ...
        // Add price & purchase button if available
        if (price || mpLink) {
            const actionsContainer = document.createElement('div');
            actionsContainer.className = 'lightbox-actions';
            
            if (price) {
                const priceTag = document.createElement('div');
                priceTag.className = 'lightbox-price-tag';
                priceTag.textContent = price;
                actionsContainer.appendChild(priceTag);
            }
            ...
            if (mpLink && mpLink !== '#') {
                ...
                buyBtn.className = 'btn btn-primary lightbox-buy-btn';
                buyBtn.textContent = 'Comprar Ahora';
                actionsContainer.appendChild(buyBtn);
            }

            lightboxContainer.appendChild(actionsContainer);
        }
